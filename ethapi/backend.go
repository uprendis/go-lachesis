...
type Backend interface {
	...
	GetDelegationClaimedRewards(ctx context.Context, id sfctype.DelegatorID) (*big.Int, error)
	...
	GetDelegation(ctx context.Context, id sfctype.DelegatorID) (*sfctype.SfcDelegation, error)
}
